  ...
  return (
    <>
      <PageHeader
        ...
        title={<>Observation-led essays with one clear thesis each.</>}
        lede="Each note now reads like a short editorial case study. Minimal, structured, and expanded into its own page."
      />

      <section className="mx-auto max-w-6xl space-y-6 px-6 pb-28">
        <div className="max-w-3xl text-sm leading-relaxed text-charcoal/68">
          Four notes, each treated like a thesis fragment. Open one and the page becomes the note.
        </div>
            ...
            >
              ...
              <div className="flex flex-col justify-between border-t border-border pt-5 md:border-l md:border-t-0 md:pl-6 md:pt-0">
                <div className="max-w-2xl space-y-3">
                  <p className="text-sm leading-relaxed text-charcoal/68">{note.lede}</p>
                  <p className="text-sm leading-relaxed text-charcoal/82">{note.summary}</p>
                </div>
